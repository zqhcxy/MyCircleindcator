package com.github.zqhcxy.mycircleindcator.views;
...
import com.github.zqhcxy.mycircleindcator.R;

/**
 * Created by zqhcxy on 2016/3/2.
 */
public class CircleIndicator extends LinearLayout {
    ...
    /**
     * 设置圆点的形状与颜色
     * <p></注：必须在实例化后进行设置，否则第一个无效>
     *
     * @param cirCleDrawable drawable文件id，包含颜色与形状
     */
    public void setIndicatorBackground(int cirCleDrawable) {
        mIndicatorBackgroundResId = cirCleDrawable;
    }
     ...
     */
    public void setIndicatorUnselectedBackground(int unselectedDrawable) {
        mIndicatorUnselectedBackgroundResId = unselectedDrawable;
    }
